...
export default function UserReport({ time, setTime }: Props) {
  return (
    <section className="bg-navy-900 w-full rounded-[1rem]">
      <div className="flex items-center space-x-300 rounded-[1rem] bg-purple-600 p-[2rem] text-white">
        <img
      ...
      <div className="textPreset5Regular flex h-fit items-start justify-between gap-[21px] p-[2rem]">
        <button
          onClick={() => {
            setTime("daily");
          }}
